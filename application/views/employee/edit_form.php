    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <!-- <form href="" method="post" class="form-horizontal"> -->
 			...
 			<?= form_open('admin/employee/edit_process/'.$employee->id,['class'=>'form-horizontal']); ?>
                    ...
                    <!-- <input type="email" class="form-control" id="inputEmail3" placeholder="Email"> -->
                     ...
                     <?php
                     	...
                     	$company = [
                     		...
                     		'id'=>'company',
                     		'class' => 'form-control',
                     		'value'=>(!empty($employee))? $employee->company : "",
                     		'placeholder' => 'Company',
                     	];
                    ...
                    <!-- <input type="email" class="form-control" id="inputEmail3" placeholder="Email"> -->
                     ...
                     <?php
                     	...
                     	$last_name = [
                     		...
                     		'id'=>'last_name',
                     		'class' => 'form-control',
                     		'value'=>(!empty($employee))? $employee->last_name : "",
                    ...
                    <!-- <input type="email" class="form-control" id="inputEmail3" placeholder="Email"> -->
                     ...
                     <?php
                     	...
                     	$first_name = [
                     		...
                     		'id'=>'first_name',
                     		'class' => 'form-control',
                     		'value'=>(!empty($employee))? $employee->first_name : "",
                    ...
                    <!-- <input type="email" class="form-control" id="inputEmail3" placeholder="Email"> -->
                     ...
                     <?php
                     	...
                     	$email = [
                     		...
                     		'id'=>'email_address',
                     		'class' => 'form-control',
                     		'value'=>(!empty($employee))? $employee->email_address : "",
                     		'placeholder' => 'Email',
                     	];
